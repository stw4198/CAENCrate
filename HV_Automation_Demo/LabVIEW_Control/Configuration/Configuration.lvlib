...
<Library LVVersion="18008000">
	...
	<Item Name="Call Config.vi" Type="VI" URL="../Call Config.vi"/>
	<Item Name="Config Settings FGV.vi" Type="VI" URL="../Config Settings FGV.vi"/>
	<Item Name="config.ini" Type="Document" URL="../config.ini"/>
	<Item Name="Read Write Config.vi" Type="VI" URL="../Read Write Config.vi"/>
</Library>
